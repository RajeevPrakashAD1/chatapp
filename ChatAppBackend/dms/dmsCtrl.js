...
const Dms = require('./dmsschema.js');
...
exports.createDms = catchAsync(async (req, res, next) => {
	const newDms = await Dms.create(req.body);
	res.send({ status: 'Dms inserted successfully', dms: newDms });
	res.status(200);
});
